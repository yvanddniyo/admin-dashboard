...
const Sidebar = () => {
  return (
    <div className='sidebar flex-1 h-[calc(100vh-50px)]  sticky top-[50px] '>
      <div className="sideWrapper p-5 text-[#555]">
        <div className="sidebarmenu mb-[10px] ">
          ...
          <ul className="sidebarList list-none p-1">
            <li className="sidebarListitem  p-1 cursor-pointer flex items-center bg-gray-400 hover:bg-gray-400 rounded-[10px]">
              < LineStyle className='mr-3 text-[20px]' /> Home
            </li>
            <li className="sidebarListitem p-1 cursor-pointer flex items-center active:bg-gray-600 hover:bg-gray-400 rounded-[10px]">
